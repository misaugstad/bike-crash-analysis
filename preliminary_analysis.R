...
crash.data<- read.csv(file="~/Dropbox/Course@UMD/INFM750/Project/R scripts/All_data.csv", header=TRUE, sep=",")
...
write.csv(crash.data, file= "~/Dropbox/Course@UMD/INFM750/Project/R scripts/bikecrash_2012.csv")
